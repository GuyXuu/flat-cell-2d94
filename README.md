...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/flat-cell-2d94
```

A live public deployment of this template is available at [https://flat-cell-2d94.templates.workers.dev](https://flat-cell-2d94.templates.workers.dev)
